...
import io.mosip.tf.t5.cryptograph.controller.CryptographController;
import io.mosip.tf.t5.cryptograph.dto.ErrorDTO;
import io.mosip.tf.t5.cryptograph.dto.PrintResponse;
import io.mosip.tf.t5.cryptograph.exception.AccessDeniedException;
import io.mosip.tf.t5.cryptograph.exception.InvalidTokenException;
...
import io.mosip.tf.t5.cryptograph.exception.RegStatusAppException;
import io.mosip.tf.t5.cryptograph.exception.TemplateProcessingFailureException;
 ...
 */
@RestControllerAdvice(assignableTypes = CryptographController.class)
public class PrintExceptionHandler {
	...
	/** The reg proc logger. */
	private static Logger regProcLogger = CryptographLogger.getLogger(PrintExceptionHandler.class);
