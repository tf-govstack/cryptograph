...
import io.mosip.tf.t5.cryptograph.dto.Metadata;
import io.mosip.tf.t5.cryptograph.dto.PasswordRequest;
import io.mosip.tf.t5.cryptograph.dto.SecretKeyRequest;
import io.mosip.tf.t5.cryptograph.dto.TokenRequestDTO;
import io.mosip.tf.t5.cryptograph.exception.TokenGenerationFailedException;
...
public class RestApiClient {
	...
	/** The logger. */
	private final Logger logger = CryptographLogger.getLogger(RestApiClient.class);
