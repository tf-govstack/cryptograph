...
import io.mosip.tf.t5.cryptograph.exception.BiometricTagMatchException;
...
public class CbeffToBiometricUtil {
	...
	/** The reg proc logger. */
	private static Logger regProcLogger = CryptographLogger.getLogger(CbeffToBiometricUtil.class);
