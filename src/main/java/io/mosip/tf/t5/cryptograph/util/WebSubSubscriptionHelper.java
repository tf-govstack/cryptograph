...
import io.mosip.tf.t5.cryptograph.model.CredentialStatusEvent;
...
public class WebSubSubscriptionHelper {
	...
	private static final Logger LOGGER = CryptographLogger.getLogger(WebSubSubscriptionHelper.class);
	...
	private void subscribeForPrintServiceEvents() {
		try {
			...
			LOGGER.info(subscriptionRequest.getCallbackURL(), subscriptionRequest.getHubURL(), subscriptionRequest.getSecret(), subscriptionRequest.getTopic());
